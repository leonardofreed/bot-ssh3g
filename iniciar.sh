...
wget https://raw.githubusercontent.com/leonardofreed/bot-ssh3g/master/gerarusuario-sshplus.sh?dl=0 -O gerarusuario.sh; chmod +x gerarusuario.sh > /dev/null

wget https://github.com/leonardofreed/bot-ssh3g/raw/master/%40admysshbot.zip -O bot.zip && unzip bot.zip > /dev/null
